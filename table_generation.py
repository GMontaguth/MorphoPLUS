...
def tables(table,field,position_center,size):
	...
	mascara = np.logical_or.reduce([ N2['X'] >= (size - 25), N2['X'] <= 25, N2['Y'] >= (size - 25), N2['Y'] <= 25])
	N3= N2[mascara]
	N4=N2[(N2['X']<(size-25)) & (N2['X']>25) & (N2['Y']<(size-25)) & (N2['Y']>25)] #las galaxias donde se hara el ajuste\
